package com.Dangerdawgz111.DogUpgradesMod.blocks.itemblocks;
...
public class ItemBlockDoor extends ItemBlock
{
	...
	private static void placeDoor(World worldIn, BlockPos bottomDoorPos, EnumFacing playerFacing, Block door, boolean isRangeHinge)
	{
		...
		worldIn.setBlockState(bottomDoorPos, doorState.withProperty(BlockDoor.HALF, EnumDoorHalf.LOWER));
		worldIn.setBlockState(topDoorPos, doorState.withProperty(BlockDoor.HALF, EnumDoorHalf.UPPER));
